...
Two middleware functions are provided by default in the `masquerade.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `masquerade.handler` namespace to manage the enabled middleware.
